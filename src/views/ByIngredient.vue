...
<template>
    <div class="bg-slate-50 min-h-full pt-12 px-12">
        <h2 class="md:text-5xl sm:text-3xl text-xl px-4 uppercase text-slate-700 py-8 bg-slate-100 text-center">Listing all the recipes for ingredient
            <span class="text-red-500 font-semibold">"{{ route.params.ingredient }}"</span> here!
        </h2>
